...
flexible system of adjustments, which allows you to apply fees or discounts to
specific order items or order as a whole.
...
License can be found [here](https://github.com/Sylius/Order/blob/master/LICENSE).
