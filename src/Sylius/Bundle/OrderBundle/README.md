...
This bundle uses [GitHub issues](https://github.com/Sylius/SyliusOrderBundle/issues).
...
License can be found [here](https://github.com/Sylius/SyliusOrderBundle/blob/master/Resources/meta/LICENSE).

Authors
-------

The bundle was originally created by [Paweł Jędrzejewski](http://pjedrzejewski.com).
See the list of [contributors](https://github.com/Sylius/SyliusOrderBundle/contributors).
