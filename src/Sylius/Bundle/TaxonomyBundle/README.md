...
This bundle uses [GitHub issues](https://github.com/Sylius/SyliusTaxonomyBundle/issues).
...
License can be found [here](https://github.com/Sylius/SyliusTaxonomyBundle/blob/master/Resources/meta/LICENSE).
