                ...
                ->arrayNode('classes')
                    ...
                    ->children()
                        ->arrayNode('shipment')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('model')->defaultValue('Sylius\Component\Shipping\Model\Shipping')->end()
                        ...
                        ->arrayNode('shipment_item')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('model')->defaultValue('Sylius\Component\Shipping\Model\ShippingItem')->end()
